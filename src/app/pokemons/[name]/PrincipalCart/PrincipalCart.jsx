    ...
    <PokemonHero image={pkmn.sprites.other["official-artwork"].front_default}>
      <div className="pl-1 md:p-2 relative">
        <section className="absolute right-1 top-1  xl:right-[10%]  xl:top-[13%] text-[0.4em] z-20">
          <GenerationBadge
            generation={pkmn.generation.name}
            getMain_region={pkmn.main_region}
          />
        </section>
        {/* Nombre */}
        ...
        <section className=" flex flex-col pb-4">
          ...
          >
            <section className="flex gap-3 text-[0.5em] justify-center">
              {pkmn.types.map((t) => (
                <TipePokemon name={t.type.name} key={t.type.name} />
              ))}
            </section>
          </div>
          ...
          >
            {/* panel izquierdo */}
            <div
              className="w-[26%] grid-col  grid-cols-1  space-y-1 md:space-y-6"
              style={{
                WebkitMaskImage:
                  "radial-gradient(circle at 214% 50%, transparent 50%, black 51%)",
                maskImage:
                  "radial-gradient(circle at 214% 50%, transparent 50%, black 51%)",
              }}
            >
            ...
            {/* section derecha */}
            <div
              className="w-[26%] justify-start flex flex-col gap-y-4 md:gap-y-8"
              style={{
                WebkitMaskImage:
                  "radial-gradient(circle at -95% 50%, transparent 50%, black 51%) ",
                maskImage:
                  "radial-gradient(circle at -95% 50%, transparent 50%, black 51%)",
              }}
            >
              ...
              >
                <div className=" text-start flex justify-around pr-2 text-[0.6em]">
                  <div>
                    <h3 className=" font-black  opacity-80">Height</h3>
                    <span>{pkmn.height / 10 + " m"}</span>
                  </div>
                  <div className="md:w-[60%]">
                    <h3 className="font-black  opacity-80">Gender</h3>
                    <GenderRatio rate={pkmn.gender_rate} />
                  </div>
                </div>
                <div className=" text-start flex justify-around pr-2 md:pr-8 text-[0.6em]  gap-2">
                  <div>
                    <h3 className=" font-black  opacity-80">Weight</h3>
                    <span>{pkmn.weight / 10 + " kg"}</span>
                  </div>
                  <div>
                    <h3 className=" font-black  opacity-80">genera</h3>
                    <span className="text-[1.02em] font-semibold">
                      {pkmn.genera}
                    </span>
                  </div>
                </div>
          ...
          >
            <section
              className="
                        ...
                        "
            >
              <p className="text-[0.4em] ">{description}</p>
            </section>
          </div>
        </section>
      </div>
